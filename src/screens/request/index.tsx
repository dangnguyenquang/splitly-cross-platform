      ...
      <SectionList
        ...
        renderItem={({ item, index, section }) => (
            <MoneyRequestCard ownerName="Tien Loc" amount="194,000 VND" requestPersonName='Hoai Bao'
                showDivider={index < section.data.length - 1} handleOnPressRequestButton={()=>setModalVisible(true)}/>
        )}
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <Divider/>
              <View style={{width:380,height:137,borderRadius:12,alignSelf:'center',justifyContent:'center',alignItems:'center',padding:24,margin:24,backgroundColor:'#F5F5F5'}}>
                <Text style={{fontSize:16}}>Amount</Text>
                <Text style={{fontSize:40}}>100,000 VND</Text>
                <Text style={{fontSize:12}}>Your available balance: 100,000 VND</Text>
              </View>
              <SectionDivider title={'Request to'}/>
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'flex-start',gap:20,margin:20}}>
                ...
                <View>
                  <Text style={{color:'black',fontWeight:'bold'}}>Lucian Nguyen</Text>
                  <Text style={{color:colors.secondary,fontWeight:'bold'}}>lucian.nguyen@gmail.com</Text>
                </View>
              </View>
              <Divider/>
              <View style={{padding:24}}>
                <Text style={{fontSize:16,fontWeight:'bold',marginBottom:24}}>Notes(Optional)</Text>
                <Text style={{backgroundColor:'#F5F5F5',width:'100%',height:87,borderRadius:10,padding:20}}>Having break first at HCM</Text>
              </View>
              
              <View style={{position: 'absolute',bottom: 20,flexDirection:'row',justifyContent:'center',gap:20,alignItems:'center',alignSelf:'center'}}>
                <CustomButton title={'Cancel'} width={180} height={54} type='secondary' onPress={()=>setModalVisible(!modalVisible)}/>
                <CustomButton title={'Request'} width={180} height={54} onPress={()=>{
