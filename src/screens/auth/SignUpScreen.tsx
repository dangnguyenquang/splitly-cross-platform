    ...
    <SafeAreaView className="flex-1 bg-white">
      <AvoidKeyboard>
        ...
        >
          ...
          <Text className="text-base font-normal mt-4 mb-6">
            Please enter email and password to sign up
          </Text>
          <ErrorToastify errors={errors} onClose={() => setError('root', { type: 'server', message: '' })}/>
          <View className="">
            <Controller
              control={control}
              name="userName"
              ...
              render={({ field: { onChange, onBlur, value } }) => (
                <InputAuth
                  icon={<FontAwesome name="user-o" size={24} />}
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value } }) => (
                <InputAuth
                  icon={<MaterialDesignIcons name="phone" size={24} />}
          ...
          <View className="pt-6 flex-row justify-start">
            <CheckBox
              value={isChecked}
          ...
          <View className='border-t border-gray-200 mt-5'></View>
          <View className="pt-6">
            <FooterContent
